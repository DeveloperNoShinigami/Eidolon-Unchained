...
.define("conversation_sound_id", "none");
            ...
            chantCastingMode = builder
                .comment("Chant casting mode:",
                         ...
                         "ACTIVE_CHANTING - Real-time chant building with visual feedback")
            ...
            ttsProvider = builder
                .comment("TTS provider to use: player2 (Player2App/API), webapi (custom /tts endpoints), or google (Google Cloud Text-to-Speech)")
                .defineInList("provider", "player2", java.util.Arrays.asList("player2", "webapi", "google"));
            ...
            requiredOpLevel = builder
                ...
                .defineInRange("required_op_level", 0, 0, 4);
