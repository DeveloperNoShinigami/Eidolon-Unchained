...
public class NetworkEventHandler {
     ...
     * This prevents networking issues during connection
     * TEMPORARILY DISABLED - troubleshooting connection issues
     */
    @SubscribeEvent
    public static void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        if (event.getEntity() instanceof ServerPlayer serverPlayer) {
            ...
            // TODO: Re-enable deity sync once networking issues are resolved
            /* 
            try {
                // Send deity sync packet to the player
                ...
                // Don't throw exception - allow player to join even if sync fails
            }
            */
        }
    }
